...
public class KafkaSpoutConfig implements Serializable {
    ...
    public String topic = "logstash";
    public String zkRoot = "/jstorm";
    ...
    public boolean printSendInfo = false;
    ...
    public KafkaSpoutConfig(Properties properties) {
        ...
        fetchMaxBytes = JStormUtils.parseInt(getConfig("kafka.fetch.max.bytes"), 10240 * 1024);
